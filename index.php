            ...
            <div class="product-scroll">
                ...
                <div class="product-container" data-product="1">
                    <div class="product-img-container">
                        <img class="product" src="./products/1/Jacka_Blå/Jacka_Bla_Vitt.png">
                    </div>
                ...
                <div class="product-container" data-product="3">
                    <div class="product-img-container">
                        <img class="product" src="./products/3/Väska_Vit_sand.png">
                    </div>
                    <div class="expand-product">
                ...
                <div class="product-container" data-product="4">
                    <div class="product-img-container">
                        <img class="product" src="./products/4/Ring_Guld_Silver_Vit.png">
                    </div>
                    <div class="expand-product">
